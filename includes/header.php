...
<head>
    ...
    <title><?php echo SITE_NAME; ?> - <?php echo isset($page_title) ? $page_title : 'Home'; ?></title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo SITE_URL; ?>/help.php">Help</a>
                    </li>
                </ul>
                <ul class="navbar-nav">
                    <?php if(isset($_SESSION['user_id'])): ?>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo SITE_URL; ?>/profile.php">Profile</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo SITE_URL; ?>/sell.php">Sell</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <?php else: ?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo SITE_URL; ?>/registration.php">Register</a>
                        </li>
                    <?php endif; ?>
                </ul>
            </div>
